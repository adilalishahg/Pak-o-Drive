            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', minWidth: 0 }}>
              ...
              <div style={{ minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <h3
                    className="leading-normal py-0.5 font-bold truncate"
                    style={{ fontSize: '14.5px', color: '#ffffff', margin: 0 }}
                  >
                    Pak-o-Drive Support
                  </h3>
                  <span
                ...
                <p
                  ...
                  style={{ fontSize: '11.5px', color: '#94a3b8', margin: 0 }}
                >
                  {isAgentLive ? (
                    <span style={{ color: '#60a5fa', fontWeight: 600 }}>🟢 Agent Live (#{shortCode})</span>
                  ) : (
                    <span>Online • Ali (Sales & Support)</span>
                  )}
                </p>
              </div>
            </div>
