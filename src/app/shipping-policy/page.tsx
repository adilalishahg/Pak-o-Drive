            ...
            >
              {loading ? (
                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: parseMarkdown(info.shippingPolicy) }}
                />
              ) : (
                <div className="text-center py-5">
                  <p className="text-muted mb-0">No Shipping Policy content is configured yet. Check back soon!</p>
                </div>
              )}
            </div>
          </div>
