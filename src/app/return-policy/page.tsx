            ...
            >
              {loading ? (
                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: parseMarkdown(info.returnPolicy) }}
                />
              ) : (
                <div className="text-center py-5">
                  <p className="text-muted mb-0">No Return Policy content is configured yet. Check back soon!</p>
                </div>
              )}
            </div>
          </div>
